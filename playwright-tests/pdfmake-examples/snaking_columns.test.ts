...
// https://github.com/bpampuch/pdfmake/blob/master/examples/snaking_columns.js
var loremIpsum =
  'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. '

function generateTableBody(rowCount: number) {
  let tableBody = []
...
function generateTextNodes(count: number) {
  var items: Content[] = []
  for (var i = 1; i <= count; i++) {
...
function generateUnbreakableCards(count: number) {
  var cards: Content[] = []
  for (var i = 1; i <= count; i++) {
    cards.push({
      stack: [
...
const document: TDocumentDefinitions = {
  content: [
    ...
    {
      text: 'Content After Snaking Columns',
      style: 'subheader',
      margin: [0, 10, 0, 5],
    },
    {
    ...
    {
      text: 'Snaking Columns with Different Widths',
      style: 'header',
      pageBreak: 'before',
    },
    ' ',
    ...
    {
      text: 'Example 1: Narrow Left Column (200pt) + Wide Right Column (*)',
      style: 'subheader',
    },
    {
    ...
    {
      text: 'Example 3: Three Columns with Mixed Widths',
      style: 'subheader',
      pageBreak: 'before',
    },
    {
      text: 'Content flows through three columns: 150pt, *, and 100pt.',
      style: 'description',
    },
    ' ',
    ...
    {
      text: 'Columns are adjacent with no space between them.',
      style: 'description',
    },
    ' ',
    ...
    {
      text: 'Example 2: Small Gap (columnGap: 10)',
      style: 'subheader',
      pageBreak: 'before',
    },
    ...
    {
      text: 'Example 3: Default Gap (columnGap: 30)',
      style: 'subheader',
      pageBreak: 'before',
    },
    ...
    {
      text: 'Example 4: Large Gap (columnGap: 60)',
      style: 'subheader',
      pageBreak: 'before',
    },
    {
      text: 'A wide 60pt gap creates strong visual separation.',
      style: 'description',
    },
    ' ',
    ...
    {
      text: 'Snaking Columns with Table',
      style: 'header',
      pageBreak: 'before',
    },
    ...
    {
      text: 'Example 3: Table with headerRows and keepWithHeaderRows',
      style: 'subheader',
    },
    { text: '', style: 'description' },
    ' ',
    ...
    {
      text: 'Nested Columns Inside Snaking Columns',
      style: 'header',
      pageBreak: 'before',
    },
    {
    ...
    {
      text: 'Section 2: Inventory Report',
      style: 'header',
      margin: [0, 0, 0, 10],
    },
    {
    ...
    { text: '', pageBreak: 'before' },
    {
      text: 'Section 3: Multi-Region Data',
      style: 'header',
      margin: [0, 0, 0, 10],
    },
    {
    ...
    {
      text: 'Unbreakable Cards in Snaking Columns',
      style: 'header',
      pageBreak: 'before',
    },
    {
    ...
    {
      text: 'All cards remained intact while flowing across columns.',
      style: 'description',
    },

    {
      text: 'SVG Content in Snaking Columns',
      style: 'header',
      pageBreak: 'before',
    },
    {
      ...
      columns: [
        {
          stack: [
            ...
            {
              text: 'Section 5: Status Indicators',
              style: 'sectionTitle',
              marginTop: 15,
            },
            {

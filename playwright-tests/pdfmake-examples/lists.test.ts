...
// https://github.com/bpampuch/pdfmake/blob/master/examples/lists.js
const document: TDocumentDefinitions = {
  content: [
    ...
    { reversed: true, ol: ['item 1', 'item 2', 'item 3'] },
    { text: '\n\nOrdered list with start value', style: 'header' },
    { start: 50, ol: ['item 1', 'item 2', 'item 3'] },
    ...
    { type: 'upper-alpha', ol: ['item 1', 'item 2', 'item 3'] },
    ...
    { type: 'none', ol: ['item 1', 'item 2', 'item 3'] },
  ...
  styles: { header: { bold: true, fontSize: 15 } },
  defaultStyle: { fontSize: 12 },
}

test('pdfmake/lists', async ({ page }) => {

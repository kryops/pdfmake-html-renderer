...
// https://github.com/bpampuch/pdfmake/blob/master/examples/columns_simple.js
const document: TDocumentDefinitions = {
  content: [
    ...
    {
      columns: [
        { width: 'auto', text: 'val1' },
        { width: 'auto', text: 'val2' },
        { width: 'auto', text: 'value3' },
        { width: 'auto', text: 'value 4' },
      ],
    },
...
test('pdfmake/columns-simple', async ({ page }) => {
